...
char ERRTXT[1024]
  ="";
char *Program_name=(char*)"black_flag";
char *Program_version=(char*)"unknown";
int Already_reported_crash=0;

int black_flag(int bug_level,
	       std::string sourcefile,
	       int sourceline,
	       std::string sourcefile_revision)
{
  static int last_line= -1;
  char *error_names[max_black_flag_type]
    ={(char*)"CRASH",(char*)"DIED",(char*)"EXCEPTION",(char*)"BAD_DATA",(char*)"WARNING",(char*)"DEBUG"};
